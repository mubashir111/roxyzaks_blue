...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Added .btn-navbar and .btn-gold-rect to selector
    const bookBtns = document.querySelectorAll('.btn-book, .btn-peach, .btn-gold, .btn-navbar, .btn-gold-rect, .btn-location-visit');
    ...
    const heroTitle = document.querySelector('.fashion-title');
    ...
    if (cursor) {
        ...
        // Optional: Add hover scale for other interactive elements (links, buttons)
        document.querySelectorAll('a, button, .video-card-3d, .service-card-modern').forEach(el => {
